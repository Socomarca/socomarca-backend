...
<html lang="es">
  ...
  <body>
    <div class="container">
      ...
      <p>¡Gracias por registrarte en Socomarca!</p>

      <p>
        Ya eres parte de nuestra comunidad y podrás acceder a cientos de
        productos mayoristas con precios convenientes, sin salir de tu negocio.
      </p>

      <p>🛒 <strong>¿Qué puedes hacer desde tu cuenta?</strong></p>
      <ul>
        <li>Comprar fácil y rápido con despacho a domicilio</li>
