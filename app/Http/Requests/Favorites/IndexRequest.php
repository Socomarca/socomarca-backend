...
class IndexRequest extends FormRequest
{
    ...
    public function messages()
    {
        ...
        [
            ...
            'favorite_list_id.required' => 'The user_id field in query params is required.',
            'favorite_list_id.integer' => 'The user_id field in query params must be an integer.',
            'favorite_list_id.exists' => 'The selected user in query params is invalid.',
        ];
    }
}
